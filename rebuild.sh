...
echo "======================================"
sleep 5
curl -s http://localhost:8000/health | python3 -m json.tool 2>/dev/null || echo "⚠️  API not ready yet, wait a few more seconds and try: curl http://localhost:8000/health"
