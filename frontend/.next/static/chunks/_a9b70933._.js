...
function DashboardPage() {
    ...
    const uploadMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$jobs$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jobsApi"].upload,
        onSuccess: {
            "DashboardPage.useMutation[uploadMutation]": (data)=>{
                setUploadSuccess(data.job_id);
                setSelectedFile(null);
                setCustomName("");
                // Redirect to job status page after 2 seconds
                setTimeout({
                    "DashboardPage.useMutation[uploadMutation]": ()=>{
                        router.push("/jobs/".concat(data.job_id));
                    }
                }["DashboardPage.useMutation[uploadMutation]"], 2000);
            }
        }["DashboardPage.useMutation[uploadMutation]"]
    });
    const handleLogout = ()=>{
...
_s(DashboardPage, "fQnVLPdE3ugjG2dYbw/oALFadXY=", false, function() {
    return [
...
//# sourceMappingURL=_a9b70933._.js.map