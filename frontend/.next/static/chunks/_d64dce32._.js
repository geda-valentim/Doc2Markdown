...
const jobsApi = {
    async convert (request) {
        ...
        const response = await fetch("".concat(API_URL, "/convert"), {
            method: "POST",
            headers: getHeaders(true),
            body: formData
        });
        if (!response.ok) {
            throw new Error("Conversion failed: ".concat(response.statusText));
        }
        return response.json();
    },
    ...
    async getStatus (jobId) {
        const response = await fetch("".concat(API_URL, "/jobs/").concat(jobId), {
            headers: getHeaders(true)
        });
        if (!response.ok) {
            throw new Error("Failed to fetch job status: ".concat(response.statusText));
        }
        return response.json();
    },
    async getResult (jobId) {
        const response = await fetch("".concat(API_URL, "/jobs/").concat(jobId, "/result"), {
            headers: getHeaders(true)
        });
        if (!response.ok) {
            throw new Error("Failed to fetch job result: ".concat(response.statusText));
        }
        return response.json();
    },
    async getPages (jobId) {
        const response = await fetch("".concat(API_URL, "/jobs/").concat(jobId, "/pages"), {
            headers: getHeaders(true)
        });
        if (!response.ok) {
            throw new Error("Failed to fetch job pages: ".concat(response.statusText));
        }
        return response.json();
    },
    async list (params) {
        ...
        if (params === null || params === void 0 ? void 0 : params.status) searchParams.set("status", params.status);
        if (params === null || params === void 0 ? void 0 : params.job_type) searchParams.set("job_type", params.job_type);
        const url = "".concat(API_URL, "/jobs").concat(searchParams.toString() ? "?".concat(searchParams) : "");
        const response = await fetch(url, {
            headers: getHeaders(true)
        });
        if (!response.ok) {
            throw new Error("Failed to fetch jobs: ".concat(response.statusText));
        }
        return response.json();
    },
    async search (params) {
        ...
        const response = await fetch("".concat(API_URL, "/jobs/search?").concat(searchParams), {
            headers: getHeaders(true)
        });
        if (!response.ok) {
    ...
    async cancel (jobId) {
        const response = await fetch("".concat(API_URL, "/jobs/").concat(jobId, "/cancel"), {
            method: "POST",
            headers: getHeaders(true)
        });
        if (!response.ok) {
            throw new Error("Failed to cancel job: ".concat(response.statusText));
        }
        return response.json();
    },
    async getPageResultByNumber (jobId, pageNumber) {
        ...
        if (!page) {
            throw new Error("Page ".concat(pageNumber, " not found"));
        }
    ...
    async delete (jobId) {
        ...
        if (!response.ok) {
            throw new Error("Failed to delete job: ".concat(response.statusText));
        }
        return response.json();
    },
    async retryPage (pageJobId) {
        const response = await fetch("".concat(API_URL, "/jobs/").concat(pageJobId, "/retry"), {
            method: "POST",
            headers: getHeaders(true)
        });
        if (!response.ok) {
            throw new Error("Failed to retry page: ".concat(response.statusText));
        }
...
const apiKeysApi = {
    async list () {
        const response = await fetch("".concat(API_URL, "/api-keys"), {
            headers: getHeaders(true)
        });
        if (!response.ok) {
            throw new Error("Failed to list API keys: ".concat(response.statusText));
        }
        const data = await response.json();
    ...
    async revoke (keyId) {
        const response = await fetch("".concat(API_URL, "/api-keys/").concat(keyId), {
            method: "DELETE",
            headers: getHeaders(true)
        });
        if (!response.ok) {
            throw new Error("Failed to revoke API key: ".concat(response.statusText));
        }
        return response.json();
    }
};
...
function DashboardPage() {
    ...
    const hasHydrated = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])({
        "DashboardPage.useAuthStore[hasHydrated]": (state)=>state._hasHydrated
    }["DashboardPage.useAuthStore[hasHydrated]"]);
    ...
    const convertMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jobsApi"].convert,
        onSuccess: {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                    ...
                                    children: [
                                        ...
                                        convertMutation.isError && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(DashboardPage, "luRiio/WGSsD8xZ3T8ZADploz5k=", false, function() {
    return [
...
//# sourceMappingURL=_d64dce32._.js.map