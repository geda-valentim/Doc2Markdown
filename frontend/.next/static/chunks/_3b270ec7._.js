...
function RegisterPage() {
    ...
    const registerMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].register,
        onSuccess: {
        ...
        onError: {
            "RegisterPage.useMutation[registerMutation]": (error)=>{
                ...
                setError(((_error_response = error.response) === null || _error_response === void 0 ? void 0 : (_error_response_data = _error_response.data) === null || _error_response_data === void 0 ? void 0 : _error_response_data.detail) || "Registration failed. Please try again.");
            }
        }["RegisterPage.useMutation[registerMutation]"]
    });
...
//# sourceMappingURL=_3b270ec7._.js.map