...
function LoginPage() {
    ...
    const setAuth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])({
    ...
    const loginMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].login,
        onSuccess: {
            "LoginPage.useMutation[loginMutation]": async (data)=>{
                ...
                const userResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].me();
        ...
        onError: {
            "LoginPage.useMutation[loginMutation]": (error)=>{
                ...
                setError(((_error_response = error.response) === null || _error_response === void 0 ? void 0 : (_error_response_data = _error_response.data) === null || _error_response_data === void 0 ? void 0 : _error_response_data.detail) || "Login failed. Please try again.");
            }
        }["LoginPage.useMutation[loginMutation]"]
    });
...
_s(LoginPage, "C+LuMFwx3VgSn6uHgJ2CVmD/GsU=", false, function() {
    return [
...
//# sourceMappingURL=_7419530c._.js.map