...
function JobStatusPage(param) {
    ...
    const handlePageClick = (pageNumber, pageStatus)=>{
                                        ...
                                        (status === null || status === void 0 ? void 0 : status.pages) && status.pages.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: status.pages.map((page)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                            onClick: ()=>handlePageClick(page.page_number, page.status),
                                                            disabled: page.status !== "completed",
                                                            className: "\n                          relative group h-10 sm:h-9 md:h-8 rounded border-2 flex items-center justify-center text-xs font-medium transition-all cursor-pointer hover:scale-105 active:scale-95 disabled:cursor-not-allowed disabled:hover:scale-100\n                          ".concat(page.status === "completed" ? "bg-green-500/10 border-green-500/50 text-green-700 dark:text-green-400 hover:bg-green-500/20" : page.status === "failed" ? "bg-red-500/10 border-red-500/50 text-red-700 dark:text-red-400 hover:bg-red-500/20" : page.status === "processing" ? "bg-blue-500/10 border-blue-500/50 text-blue-700 dark:text-blue-400 animate-pulse" : "bg-yellow-500/10 border-yellow-500/50 text-yellow-700 dark:text-yellow-400 hover:bg-yellow-500/20", "\n                        "),
                                                            title: "Page ".concat(page.page_number, ": ").concat(page.status).concat(page.status === "completed" ? " - Click to view" : ""),
                                                            children: [
                                                                page.page_number,
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(JobStatusPage, "bqDPrL5C6X7H+atMHBo75Avdk+A=", false, function() {
    return [
...
//# sourceMappingURL=_a70f968c._.js.map