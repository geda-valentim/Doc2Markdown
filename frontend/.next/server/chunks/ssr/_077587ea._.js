...
function LoginPage() {
    ...
    const loginMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authApi"].login,
        onSuccess: async (data)=>{
            // Save token first so it's available for subsequent requests
            localStorage.setItem("auth_token", data.access_token);
            // Get user info with the token now in localStorage
            const userResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authApi"].me();
            setAuth(userResponse, data.access_token);
            router.push("/dashboard");
        },
        onError: (error)=>{
            setError((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatApiError"])(error, "Login failed. Please try again."));
        }
    });
...
//# sourceMappingURL=_077587ea._.js.map